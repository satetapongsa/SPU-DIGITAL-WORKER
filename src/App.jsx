    ...
    <nav className={scrolled ? 'scrolled' : ''}>
      <div className="container nav-content">
        <div className="logo" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <img src="https://www.spu.ac.th/fac/it/th/static/images/logo_it.png" alt="SPU IT" style={{ height: '35px' }} />
          ...
          <div className="footer-content">
            <div className="footer-brand">
              <div className="logo" style={{ marginBottom: '1.5rem' }}>
                <img src="https://www.spu.ac.th/fac/it/th/static/images/logo_it.png" alt="SPU IT" style={{ height: '50px' }} />
              </div>
